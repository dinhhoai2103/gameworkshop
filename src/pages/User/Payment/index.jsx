            ...
            <div className="container-body-container">
              ...
              <Collapse accordion>
                <Panel
                  ...
                  key="1"
                >
                  <p style={{ fontSize: "16px" }}>Nạp coin bằng QR Code</p>
                  <Formik
                    initialValues={{
                      money: "",
                    }}
                    validationSchema={Yup.object({
                      money: Yup.string().required("Bạn chưa nhập"),
                    })}
                ...
                <Panel
                  header={
                    <div className="payment-container">
                      ...
                      <div className="payment-element">
                        <span style={{ fontSize: "18px" }}>
                          <strong>Nạp thẻ Garena ( Cần nạp 100.000 VNĐ)</strong>
                        </span>
                        <span style={{ fontSize: "16px" }}>
                ...
                <Panel
                  header={
                    <div className="payment-container">
                      ...
                      <div className="payment-element">
                        ...
                        <span style={{ fontSize: "16px" }}>
                          Nạp coin tự động thông qua chuyển khoản trên ứng dụng
                          Momo, cần điền mã giao dịch.
                        </span>
                      </div>
                    </div>
                  }
                  key="4"
                >
                  <p style={{ fontSize: "16px" }}>Nạp coin qua Momo</p>
                  <Formik
                    initialValues={{
                      money: "",
                    }}
